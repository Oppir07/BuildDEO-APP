          ...
          <MenubarMenu>
               ...
               <MenubarContent style={{ position: 'relative', zIndex: 1000 }} className='bg-white shadow border w-[100px] text-start p-2 rounded pointer'>
                    <MenubarItem className='hover:bg-gray-700 transition duration-200 cursor-pointer hover:text-white p-2 rounded' >
                         <Link to={'/sa-request/detail'}>View</Link>
                    </MenubarItem>
...
// Dummy data
const rows = [
     createData(1, 'Paint Project', 'lorem ipsum..', '$56','Open', <Action />),
     createData(1, 'Paint Project', 'lorem ipsum..', '$56','Open', <Action />),
     createData(1, 'Paint Project', 'lorem ipsum..', '$56','Open', <Action />),
     createData(1, 'Paint Project', 'lorem ipsum..', '$56','Open', <Action />),
...
const headCells: readonly HeadCell[] = [
     { id: 'title', numeric: false, disablePadding: true, label: 'Titile' },
...
export default function DataTableRequest() {
     ...
     const filteredRows = rows.filter(
          (row) =>
               ...
               row.budget.toLowerCase().includes(searchQuery.toLowerCase())||
               row.Status,
     );
