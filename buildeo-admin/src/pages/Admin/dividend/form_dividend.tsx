...
export default function FormDividendPage() {
    return (
        <div style={{ margin: '50px 50px', }}>
            ...
            <button type="submit" style={{ backgroundColor: '#E31E24', color: 'white', padding: '10px 20px', float: 'right', borderRadius: '8px', marginTop: '20px', cursor: 'pointer' }}>
                Send Dividend
            </button>
        </div>
    );
