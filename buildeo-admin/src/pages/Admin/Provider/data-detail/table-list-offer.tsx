          ...
          <MenubarMenu>
               ...
               <MenubarContent style={{ position: 'relative', zIndex: 1000 }} className='bg-white shadow border w-[100px] text-start p-2 rounded pointer'>
                    <MenubarItem className='hover:bg-gray-700 transition duration-200 cursor-pointer hover:text-white p-2 rounded' >
                         <Link to={'/sa-offer/detail'}>View</Link>
                    </MenubarItem>
...
// Dummy data
const rows = [
     createData(1, 'Cupcake', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae minima numquam quos ad nulla. Neque fugiat velit consequatur illo alias libero dicta aperiam.', 305, <Action />),
     createData(1, 'Cupcake', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae minima numquam quos ad nulla. Neque fugiat velit consequatur illo alias libero dicta aperiam.', 305, <Action />),
     createData(1, 'Cupcake', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae minima numquam quos ad nulla. Neque fugiat velit consequatur illo alias libero dicta aperiam.', 305, <Action />),
