...
export default function DetailOrderDone() {
  return (
    <>
      <PageHead title="Detail Order Done" />
      <div className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
        <div className="flex justify-between items-center border-b pb-4 mb-4">
          <h1 className="text-xl text-gray-500 font-semibold">Detail Order Done</h1>
        </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="w-2/3">
            ...
            <div className="space-y-2 text-black">
              <p><strong>Name:</strong> Edward Panjaitan</p>
              <p><strong>Street:</strong> No 15 uti street off ovie palace road effurun delta state</p>
              <p><strong>City & zip code:</strong> 22411</p>
              <p><strong>Telp. Number:</strong> +49 05745 09056</p>
              <p><strong>E-mail:</strong> edu29@gmail.com</p>
              <p><strong>Category:</strong> <span className="bg-yellow-200 text-yellow-800 px-2 py-1 rounded">Painter</span></p>
            </div>
          </div>
        </div>
