          ...
          <MenubarMenu>
               ...
               <MenubarContent style={{ position: 'relative', zIndex: 1000 }} className='bg-white shadow border w-[100px] text-start p-2 rounded pointer'>
                    <MenubarItem className='hover:bg-gray-700 transition duration-200 cursor-pointer hover:text-white p-2 rounded' >
                         <Link to={'/sa-transaction/detail'}>View</Link>
                    </MenubarItem>
...
// Dummy data
const rows = [
     createData(1, 'Cupcake', 'cupcake@example.com', 305,'Credit Card', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 305,'Credit Card', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 305,'Credit Card', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 305,'Credit Card', <Action />),
...
const headCells: readonly HeadCell[] = [
     ...
     { id: 'amount', numeric: true, disablePadding: false, label: 'Phone' },
     { id: 'payment', numeric: true, disablePadding: false, label: 'Payment Method' },
