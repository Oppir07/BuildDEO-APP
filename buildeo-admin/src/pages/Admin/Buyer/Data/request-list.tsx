...
// Dummy data
const rows = [
     createData(1,'Paint project house..',2090,'Acc', <Action />),
     createData(1,'Paint project house..',2090,'Acc', <Action />),
     createData(1,'Paint project house..',2090,'Acc', <Action />),
     createData(1,'Paint project house..',2090,'Acc', <Action />),
...
export default function DataTableRequest() {
     ...
     const filteredRows = rows.filter(
          (row) =>
               ...
               row.title.toString().includes(searchQuery.toLowerCase()) ||
               row.budget.toString().includes(searchQuery.toLowerCase()) ||
