          ...
          <MenubarMenu>
               ...
               <MenubarContent style={{ position: 'relative', zIndex: 1000 }} className='bg-white shadow border w-[100px] text-start p-2 rounded pointer'>
                    <MenubarItem className='hover:bg-gray-700 transition duration-200 cursor-pointer hover:text-white p-2 rounded' >
                         <Link to={'/sa-reviews/details'}>View</Link>
                    </MenubarItem>
...
// Dummy data
const rows = [
     createData(1, 'Cupcake', 'cupcake@example.com', 'lorwm etsha hyysa hsdsb shdshj', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 'lorwm etsha hyysa hsdsb shdshj', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 'lorwm etsha hyysa hsdsb shdshj', <Action />),
     createData(1, 'Cupcake', 'cupcake@example.com', 'lorwm etsha hyysa hsdsb shdshj', <Action />),
...
const headCells: readonly HeadCell[] = [
     ...
     { id: 'Commnet', numeric: true, disablePadding: false, label: 'Comment' },
     { id: 'action', numeric: true, disablePadding: false, label: 'Manage Rating' },
];
...
export default function DataTableReviews() {
     ...
     const filteredRows = rows.filter(
          (row) =>
               ...
               row.Commnet.toString().includes(searchQuery),
     );
                                             ...
                                             .map((row, index) => {
                                                  ...
                                                  return (
                                                       ...
                                                       >
                                                            ...
                                                            <TableCell align="center">{row.Commnet}</TableCell>
