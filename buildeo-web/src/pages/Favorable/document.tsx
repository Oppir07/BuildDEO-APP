          ...
          <div>
               ...
               <div className="md:ml-[80px] md:mr-[80px] ml-4 mr-4">
                    <div className="">
                         ...
                         <div className="">Send your previous offer and BUILDEOwill help you find better prices</div>
                         <div className="">
                         ...
                         <div className="mb-10">
                              ...
                              <div className=" flex flex-col md:items-end items-center mt-4 md:justify-end justify-center">
                                   <div className="flex font-bold">
                                        ...
                                        <button className='bg-[#E31E24] text-white rounded-[40px] w-[150px] p-[7px] ml-10' onClick={send}>Send offer</button>
                                   </div>
                              </div>

                              <div className="text-[20px] mt-10 md:mt-0 md:text-[32px] font-bold">
                                   Dont have an offer yet?
                              </div>
                              <div className="">Tell what project you want to make, BUILDEO will help find better prices</div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="flex flex-col items-center bg-white p-6 rounded-lg w-[300px]">
            ...
            <p className="mt-2 text-center">
              The Cheapset Offer will be send
            </p>
            <div className="mt-4 ">
              <button
